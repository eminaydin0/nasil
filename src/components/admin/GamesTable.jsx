    ...
    <div className="space-y-5">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {selectedGames.length > 0 && (
              <Button
                ...
                className="!bg-none !bg-rose-500 hover:!bg-rose-600 !shadow-soft"
              >
                Sil ({selectedGames.length})
              </Button>
            )}
            <Button type="button" variant="secondary" size="md" iconLeft={Download} onClick={onExport}>
              Yedekle
            </Button>
            <Button type="button" variant="primary" size="md" iconLeft={Plus} onClick={onAddNew}>
              Yeni Oyun
            </Button>
          </div>
        </div>
              ...
              <tr>
                ...
                <th>
                  <button
                    type="button"
                    onClick={() => onSort('id')}
                    className="group inline-flex items-center gap-1.5 hover:text-charcoal-900"
                  >
                    ID {getSortIcon('id')}
                  </button>
                </th>
      ...
      <div className="space-y-3 md:hidden">
        {filtered.length === 0 ? (
          ...
          filtered.map((game) => (
            <AdminCard key={game.id} padding={false}>
